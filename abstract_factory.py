...
def game_level(factory):
    map_inst = factory.get_map()
    objects_inst = factory.get_objects()

    return map_inst, objects_inst


if __name__ == '__main__':
    map_easy, objects_easy = game_level(EasyLevel)
    print(map_easy.get_map())
    print(objects_easy.get_objects(map_easy))
